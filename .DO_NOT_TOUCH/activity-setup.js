...
export function setupActivity(scene) {
  ...
  new CenteredTimedText(scene, "Create your\nown stage!", {}, 1500, () => {
    loadModifyCode(scene, function() {
      ...
      let worldWidth = scene.stageArray[0].length * scene.blockWidth;
      let worldHeight = scene.stageArray.length * scene.blockHeight;
